...
resource "aws_s3_bucket" "website_root" {
  ...
  logging {
    ...
    target_prefix = "${var.route53_domain_name}/"
  }
...
resource "aws_s3_bucket" "website_redirect" {
  ...
  logging {
    target_bucket = aws_s3_bucket.website_logs.bucket
    target_prefix = "${var.route53_domain_name}-redirect/"
  }

  website {
    redirect_all_requests_to = "https://${var.route53_domain_name}"
  }
...
resource "aws_cloudfront_distribution" "website_cdn_root" {
  ...
  origin {
    ...
    domain_name = var.aws_s3_bucket_domain
